...
<div class="flex justify-center gap-10">
    <form @submit.prevent="submitForm" class=" border-2 border-slate-200 rounded-xl space-y-4 p-4 shadow-lg flex flex-col justify-between"> <!-- Use flex-1 here too; also added flex utilities to distribute space inside form -->
        <h1 class="font-bold text-2xl text-center">SignUp Form</h1>
        <div class="field">
