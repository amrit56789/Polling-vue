...
export default {
    ...
    setup() {
        ...
        const { poll, addOption, submitForm, deleteOption, error, isEdit,resetPoll } = useAddPoll(existingPoll.value);
        ...
        const handleSubmit = async () => {
            ...
            try {
                ...
                if (result) {
                    ...
                    modalMessage.value = isEdit ? "Poll updated successfully!" : "Poll created successfully!";
